...
| 项目二_AI面试官系统 | 已完成 | 2026-08-22 | 0 | ⭐⭐⭐⭐ | 阶段一至六已完成：项目骨架、JWT认证、SQLAlchemy落库、Alembic迁移、简历解析、岗位画像、LangGraph面试工作流、追问持久化、RAG题库检索、Element Plus + ECharts 企业级 HR 后台、真实历史面试 API、FastAPI静态托管、SSE流式追问、测试与阶段文档 |
| 项目二_AI面试官前端部署 | 学习中 | 2026-08-22 | 0 | ⭐⭐⭐ | 已补企业级 HR 后台、历史会话 API 与 /web 构建托管，后续进入部署阶段 |
| 系统设计面试 | 未学习 | - | 0 | - | - |
| 简历与模拟面试 | 未学习 | - | 0 | - | - |
